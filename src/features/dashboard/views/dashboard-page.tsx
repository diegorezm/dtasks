...
export function DashboardPage({ user }: DashboardPageProps) {
	...
	return (
		<SidebarInset className="dashboard-inset overflow-hidden">
			<header className="dashboard-toolbar flex h-16 shrink-0 items-center justify-between border-b px-4 md:px-7">
			...
			<div className="dashboard-content mx-auto flex w-full max-w-[1500px] flex-1 flex-col gap-8 p-4 md:p-7 lg:p-10">
				<section className="dashboard-hero rise-in flex flex-col gap-3 border-b pb-7 md:flex-row md:items-end md:justify-between">
				...
				<section className="grid gap-6 xl:grid-cols-[minmax(0,1.55fr)_minmax(320px,0.75fr)]">
					<Card className="dashboard-panel dashboard-panel-feature overflow-hidden shadow-none">
						<CardHeader>
						...
						<CardContent className="grid gap-3 md:grid-cols-3">
							{nextMoves.map((item) => (
								<button
									type="button"
									key={item.task()}
									className="dashboard-next-card flex min-h-36 flex-col items-start justify-between rounded-lg border bg-background p-4 text-left transition-colors hover:bg-muted/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
								>
